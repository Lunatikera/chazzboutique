...
private final IProveedorNegocio proveedorNegocio;
private final IProductoNegocio productoNegocio;

    /**
     * Creates new form PnlAnadirProducto
     */
    public PnlAnadirProducto(ICategoriaNegocio categoriaNegocio, IProveedorNegocio proveedorNegocio, IProductoNegocio productoNegocio) {
    ...
    cargarCategorias();
    cargarProveedores();
    configurarTabla(); // método para configurar columnas
}
private void cargarCategorias() {
    try {
        cbxCategoria.removeAllItems();
        for (CategoriaDTO categoria : categoriaNegocio.obtenerCategorias()) {
...
private void cargarProveedores() {
    try {
        ...
        for (ProveedorDTO proveedor : proveedorNegocio.obtenerProveedores()) {
